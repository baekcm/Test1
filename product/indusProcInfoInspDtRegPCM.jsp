...
<%@ page info="[2017.08.28] industry PCM 공정별 공정 정보 팝업 HTML 엘리먼트" %>
...
<div class="wp-dim-layer">
    ...
    <div id="js-indus-proc-info-insp-dt-reg-pcm-popup" class="wp-pop-layer wp-pop-w940 wp-box-sizing wp-car-popup">
    	<div class="wp-pop-title">
    		<h1><spring:message code="TODO.KEY" text="공정별 공정정보 등록-PCM"/></h1>
    		<button type="button" class="wp-btn-close-layer wp-spr-btn" id="js-indus-proc-info-insp-dt-reg-pcm-close"><span><spring:message code="TODO.KEY" text="닫기"/></span></button>
    	</div>
        <div class="wp-pop-conts">
			<!-- scroll Area -->
			<div class="wp-pop-cont-scrollable"  id="js-indus-proc-info-insp-dt-reg-pcm-proc-type-info">
			<input type="hidden" data-field="setFlag" value="" />
				...
				<div class="wp-clearfix">
					...
					<button type="button" id="js-indus-proc-info-insp-dt-reg-pcm-prod-lot-info-input-button" class="wp-btn small white bgray plus wp-mb5 wp-fr"><spring:message code="TODO.KEY" text="추가"/></button>
				</div>
				<div class="wp-table-st1" id="js-indus-proc-info-insp-dt-reg-pcm-prod-lot-info">
					<table>
						<caption></caption>
						<colgroup>
				...
				<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-dt-reg-pcm-prod-info">
					<table>
				...
				<!-- //제품 정보 -->
				<!--  ########## 아이콘 설명 ##########
				빨간 아이콘 <div class="wp-temphum wp-icon-area"><span class="wp-icon">text</span></div>
				빨간 글씨 <span class="wp-fc-red2">text</span>
		
				파란 아이콘 <div class="wp-temphum wp-icon-area"><span class="wp-icon">text</span></div>
				파란 글씨 <span class="wp-ship-fc-blue">text</span>
				 -->
				<!-- 공정 Coating Roll 정보 -->
				<h2 class="wp-cont-title"><spring:message code="TODO.KEY" text="공정 Coating Roll 정보"/></h2>
				<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-dt-reg-pcm-coating-roll-info">
					<table>
						<caption><spring:message code="TODO.KEY" text="공정 Coating Roll 정보"/></caption>
						<colgroup>
							<col style="width:15%">
							<col style="width:18%">
							<col style="width:15%">
						...
						<tbody>
							<tr>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="coatWay"><spring:message code="TODO.KEY" text="코팅 방식"/></span></div></th>
								<td class="wp-al">
									<div class="wp-ui-select wp-wd100p">
										<select title="항목 개수 설정" data-field="coatWay">
										</select>
									</div>
								</td>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="ls" ><spring:message code="TODO.KEY" text="주속비(L/S)"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="ls" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="apr" ><spring:message code="TODO.KEY" text="주속비(APR)"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="apr" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
							</tr>
							<tr>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="pur" ><spring:message code="TODO.KEY" text="주속비(PUR)"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="pur" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="mr" ><spring:message code="TODO.KEY" text="주속비(MR)"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="mr" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="nip" ><spring:message code="TODO.KEY" text="NIP 압력"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="nip" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
							</tr>
							<tr>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="pmt" ><spring:message code="TODO.KEY" text="경화 PMT(℃)"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="pmt" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="count" ><spring:message code="TODO.KEY" text="Baking 횟수"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="count" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="tlevellerTemp" ><spring:message code="TODO.KEY" text="T/Leveller 투입 전 소지 온도(℃)"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="tlevellerTemp" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
							</tr>
							<tr>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="tlevellerClean" ><spring:message code="TODO.KEY" text="T/Leveller"/><br><spring:message code="TODO.KEY" text="청소 주기"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="tlevellerClean" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
								<th class="wp-ar"><span class="wp-icon" data-field="coatNo" ><spring:message code="TODO.KEY" text="Coater No."/></span></th>
								<td class="wp-al">
									<div class="wp-ui-select wp-wd100p">
										<select title="항목 개수 설정" data-field="coatNo">
										</select>
									</div>
								</td>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="inOutState" ><spring:message code="TODO.KEY" text="육안 외관 상태"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="inOutState" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
							</tr>
							<tr>
								...
								<td class="wp-al"><input type="text" data-field="targetThickness" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="hardSec" ><spring:message code="TODO.KEY" text="경화 시간(sec)"/></span></div></th>
								<td class="wp-al"><input type="text" data-field="hardSec" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
								<td class="wp-al"></td>
								<td class="wp-al"></td>
							</tr>
						</tbody>
				...
				<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-dt-reg-pcm-diluent-info">
					<table>
						<caption><spring:message code="TODO.KEY" text="제품 정보"/></caption>
						<colgroup>
							<col style="width:15%">
						...
						<tbody>
							...
							<tr>
								...
								<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="catchState"><spring:message code="TODO.KEY" text="캐치팬內 도료"/><br><spring:message code="TODO.KEY" text="유동 상태"/></span></div></th>
								<td class="wp-al">
									<div class="wp-ui-btn-switch wp-clearfix ship-switch">
										<ul>
											<li>
											<%-- js-indus-proc-info-reg-pcm-pop-catch-state --%>
												<button type="button" class="left on" data-field="catchStateGood"><spring:message code="TODO.KEY" text="양호"/></button>
											</li>
											<li>
												<button type="button" class="right" data-field="catchStateBad"><spring:message code="TODO.KEY" text="불량"/></button>
											</li>
										</ul>
									</div>
								</td>
								...
								<td class="wp-al">
									<div class="wp-ui-btn-switch wp-clearfix ship-switch">
										<ul>
											<li>
											<%--js-indus-proc-info-reg-pcm-pop-filter-state --%>
												<button type="button" class="left on" data-field="filterStateGood"><spring:message code="TODO.KEY" text="양호"/></button>
											</li>
											<li>
												<button type="button" class="right" data-field="filterStateBad"><spring:message code="TODO.KEY" text="불량"/></button>
											</li>
										</ul>
									</div>
								</td>
				...
				<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-dt-reg-pcm-maker-info">
					<table>
						...
						<tbody>
							<tr>
								...
								<td class="wp-al wp-vm">
									...
									<button type="button" class="wp-btn small gray cr3" id="js-indus-proc-info-insp-dt-reg-pcm-maker-info-input-button"><spring:message code="TODO.KEY" text="등록"/></button>
			...
			<div class="wp-btn-area">
				<button type="button" class="wp-btn blue1 cr3 wp-pl18 wp-pr18" id="js-indus-proc-info-insp-dt-reg-pcm-set-button"><spring:message code="TODO.KEY" text="확인"/></button>
			</div>
...
<script id="js-indus-proc-info-insp-dt-reg-pcm-prod-lot-template" type="text/x-handlebars-template">
	<tr class="wp-td-padding0" data-field="items-{{index}}" name="itemsList" dataIndex="{{index}}">
		<td><input type="text" data-field="itemsNm" name="" value="{{itemsNm}}" dataIndex="{{index}}" title="<spring:message code='TODO.KEY' text=''/>" class="wp-wd189" disabled="disabled"><button type="button" name="js-indus-proc-info-insp-dt-reg-pcm-prod-list-button" dataIndex="{{index}}" data-link="js-prod-info-popup" data-depth="3" class="wp-btn small gray cr3"><spring:message code="TODO.KEY" text="조회"/></button></td>
		<td><input type="text" data-field="lotNo" name="" value="{{lotNo}}" dataIndex="{{index}}" title="<spring:message code='TODO.KEY' text=''/>" class="wp-wd100p" maxlength="10"></td>
		...
		<td>
			<button type="button" id="js-indus-proc-info-insp-dt-reg-pcm-prod-lot-delete-button-{{index}}" dataIndex="{{index}}" name="js-indus-proc-info-insp-dt-reg-pcm-prod-lot-delete-button" class="wp-btn small white bgray trash"><span><spring:message code="TODO.KEY" text="삭제"/></span></button>
		</td>
...
<script id="js-indus-proc-info-insp-dt-reg-pcm-maker-template" type="text/x-handlebars-template">		
	{{#rows}}
		<li><span data-field="makerNmList">{{makerNm}}%</span><button type="button" class="wp-spr-btn wp-close-sel" name="js-indus-proc-info-insp-dt-reg-pcm-maker-delete-button"><span><spring:message code="TODO.KEY" text="닫기"/></span></button>
...
var indusProcInfoInspDtRegPCM = (function() {
	...
	// 제품 정보,공정 Coating Roll 정보,희석 조건 data
	var procInfoDt = [];
	...
	var initData = {
		init: function(){
			...
			// 적용 공정 attr
			$procType = $('#js-indus-proc-info-insp-dt-reg-pcm-proc-type-info');
			// 적용 제품/LOT No.정보 attr
			$prodLot =  $('#js-indus-proc-info-insp-dt-reg-pcm-prod-lot-info');
			// 제품 정보 attr
			$prod = $('#js-indus-proc-info-insp-dt-reg-pcm-prod-info');
			// 공정 Coating Roll 정보 attr
			$coatingRoll = $('#js-indus-proc-info-insp-dt-reg-pcm-coating-roll-info');
			// 희석 조건 attr
			$diluent = $('#js-indus-proc-info-insp-dt-reg-pcm-diluent-info');
			// 도료 Supplier 점유율 attr
			$maker = $('#js-indus-proc-info-insp-dt-reg-pcm-maker-info');
		},
		procItemCodeMapper: function(){ // item code 에 대하여 object id 를 mapping
			// 제품 정보 
			intProcItemCodeMpperProd["select[data-field='paintId']"] = "PCM_00009"; // 도료 구분 PCM_00009
			intProcItemCodeMpperProd["select[data-field='paintResinId']"] = "PCM_00010"; // 도료 수지 타입	PCM_00010	    
			intProcItemCodeMpperProd["input[data-field='objectState']"] = "PCM_00011"; // 피도물 외관(오염여부등)	PCM_00011			
			intProcItemCodeMpperProd["input[data-field='prodOutput']"] = "PCM_00012"; // 제품 생산량	PCM_00012			
			intProcItemCodeMpperProd["input[data-field='prodStorageTerm']"] = "PCM_00013";	// 제품 저장 기간	PCM_00013	
			intProcItemCodeMpperProd["input[data-field='objectTemp']"] = "PCM_00014"; // 피도물 온도 PCM_00014
			
			// 공정 Coating Roll 정보 
			intProcItemCodeMpperCoatingRoll["select[data-field='coatWay']"] = "PCM_00015"; // 코팅 방식 PCM_00015			                                  
			intProcItemCodeMpperCoatingRoll["input[data-field='ls']"] = "PCM_00016"; 		// 주속비(L/S)	PCM_00016		                          
			intProcItemCodeMpperCoatingRoll["input[data-field='apr']"] = "PCM_00017"; // 주속비(APR)	PCM_00017			                                  
			intProcItemCodeMpperCoatingRoll["input[data-field='pur']"] = "PCM_00018"; 	// 주속비(PUR)	PCM_00018		                                  
			intProcItemCodeMpperCoatingRoll["input[data-field='mr']"] = "PCM_00019"; // 주속비(MR) PCM_00019					                                  
			intProcItemCodeMpperCoatingRoll["input[data-field='nip']"] = "PCM_00020"; // NIP 압력	PCM_00020
			intProcItemCodeMpperCoatingRoll["input[data-field='pmt']"] = "PCM_00021";	// 경화 PMT(℃)	PCM_00021
			intProcItemCodeMpperCoatingRoll["input[data-field='count']"] = "PCM_00022";	//Baking 횟수 : 신규 PCM_00022
			intProcItemCodeMpperCoatingRoll["input[data-field='tlevellerTemp']"] = "PCM_00023";	//T/Leveller 투입 전 소지 온도(℃) : 신규 PCM_00023
			intProcItemCodeMpperCoatingRoll["input[data-field='tlevellerClean']"] = "PCM_00024";	//T/Leveller 청소 주기 : 신규 PCM_00024
			intProcItemCodeMpperCoatingRoll["select[data-field='coatNo']"] = "PCM_00025"; 	// Coater No. PCM_00025	
			intProcItemCodeMpperCoatingRoll["input[data-field='inOutState']"] = "PCM_00026";	// 육안 외관 상태 PCM_00026
			intProcItemCodeMpperCoatingRoll["input[data-field='targetThickness']"] = "PCM_00027";	// Target Coating Thickness(㎛)	PCM_00027
			intProcItemCodeMpperCoatingRoll["input[data-field='hardSec']"] = "PCM_00028";	// 경화 시간(sec) PCM_00028
			
			// 희석 조건	
			intProcItemCodeMpperDiluent["input[data-field='diluent']"] = "PCM_00030";	// 희석제 종류	PCM_00030		                          
			intProcItemCodeMpperDiluent["input[data-field='diluentRate']"] = "PCM_00031";	// 희석비율(%)	PCM_00031	                          
			intProcItemCodeMpperDiluent["input[data-field='diluentVisc']"] = "PCM_00029";	// 희석후 점도(sec)	PCM_00029		                          
			intProcItemCodeMpperDiluent["input[data-field='viscTemp']"] = "PCM_00032"; // 점도 측정시 온도(℃) PCM_00032			                                  
			intProcItemCodeMpperDiluent["input[data-field='catchState']"] = "PCM_00033";	// 캐치팬內 도료 유동 상태	PCM_00033	                          
			intProcItemCodeMpperDiluent["input[data-field='filterState']"] = "PCM_00034";	// 필터상태	PCM_00034	
		},
		setInfo: function(itemType, cust, paintCust, factoryId, lineId, procItemCodeType){
			...
			// 캐치팬內 도료 유동 상태 초기화
			$diluent.find('button[data-field="catchStateGood"]').removeClass("on").addClass("on");
			$diluent.find('button[data-field="catchStateBad"]').removeClass("on");
			// 필터상태
			$diluent.find('button[data-field="filterStateGood"]').removeClass("on").addClass("on");
			$diluent.find('button[data-field="filterStateBad"]').removeClass("on");
	...
	var pageQueryEvent = {
		...
		makerAppend: function(data){ // 도료 Supplier 점유율
			...
			// 닫기 버튼 Event 
			$('button[name=js-indus-proc-info-insp-dt-reg-pcm-maker-delete-button]').off().on('click', function(){
				$(this).parent().remove();
		...
		prodLotEvent: function(){ // 적용 제품/LOT No.정보
			// 제품코드 조회 버튼 클릭
			$("button[name=js-indus-proc-info-insp-dt-reg-pcm-prod-list-button]").off().on("click", function(){
				fn_openPop($(this));
				prodItemsInfoRowIndex = $(this).attr("dataIndex");
				initRetrieveProdItemsInfoList("js-indus-proc-info-pcm-reg-popup");   
			});
			
			//삭제 버튼 클릭
			$("button[name=js-indus-proc-info-insp-dt-reg-pcm-prod-lot-delete-button]").off().on("click", function(e) {
		...
		setData: function(){ // 확인 버튼 클릭
			...
			$.each(intProcItemCodeMpperDiluent, function(key, value){ 
				var result = "";
				if(value == "PCM_00033"){
					if($diluent.find('button[data-field="catchStateGood"]').hasClass("on")){
						result = "양호";
					}else{
						result = "불량";
					}
				}else if(value == "PCM_00034"){
					if($diluent.find('button[data-field="filterStateGood"]').hasClass("on")){
						result = "양호";
					}else{
						result = "불량";
					}
				}else{
					result = $diluent.find(key).val() || "";
				}
				procInfoDt.push({
					procId: $procType.find('select[data-field="procType"]').val()
					,procItemCode: value
			...
			indusProcInfoInspRegPCM.ifFn.pageInit();
			
			$("#js-indus-proc-info-insp-dt-reg-pcm-close").click();
		},
		chkProcType: function(){
			// 적용 공정 등록 된 데이터 확인
			if(indusProcInfoInspRegPCM.chkPorcId($procType.find('select[data-field="procType"]').val())){
				app.message.alert({
					  title             : '<spring:message code="TODO.KEY" text="알림"/>'
		...
		init: function() {
			// 도료 Supplier 점유율
			var source = $('#js-indus-proc-info-insp-dt-reg-pcm-maker-template').html();
			makerListTemplate = Handlebars.compile(source);
			// 도료 Supplier 점유율(%) 등록
			$('#js-indus-proc-info-insp-dt-reg-pcm-maker-info-input-button').off().on('click', this.makerReg);
			
			// 적용 제품/LOT No.정보
			var source = $('#js-indus-proc-info-insp-dt-reg-pcm-prod-lot-template').html();
			prodLotListTemplate = Handlebars.compile(source);
			// 적용 제품/LOT No.정보 등록
			$('#js-indus-proc-info-insp-dt-reg-pcm-prod-lot-info-input-button').off().on('click', this.prodLotReg);
			// 확인 버튼
			$('#js-indus-proc-info-insp-dt-reg-pcm-set-button').off().on('click', this.setData);
	...
	var ifFn = {
		...
		setModData: function(dtProcId, dtProcInfoDt, dtShare, dtItem){
			...
			// 제품 정보, 공정 Coating Roll 정보, 도장 생산성 정보
			for(var i=0; i<procInfoDt.length; i++){
				...
				for (var key in intProcItemCodeMpperDiluent) {
					...
					if(value == procInfoDt[i].procItemCode){
						var result = "";
						if(value == "PCM_00033"){
							$diluent.find('button[data-field="catchStateGood"]').removeClass("on");
							$diluent.find('button[data-field="catchStateBad"]').removeClass("on");
							if(procInfoDt[i].procItemValue == "양호"){
								$diluent.find('button[data-field="catchStateGood"]').addClass("on");
							}else{
								$diluent.find('button[data-field="catchStateBad"]').addClass("on");
							}
						}else if(value == "PCM_00034"){
							$diluent.find('button[data-field="filterStateGood"]').removeClass("on");
							$diluent.find('button[data-field="filterStateBad"]').removeClass("on");
							if(procInfoDt[i].procItemValue == "양호"){
								$diluent.find('button[data-field="filterStateGood"]').addClass("on");
							}else{
								$diluent.find('button[data-field="filterStateBad"]').addClass("on");
							}
						}else{
		...
		success: function(response, status, jqueryXHR) {
			...
			if (typeof response.message !== 'undefined') {
				...
				if (message === 'OK') {
					...
					// 코팅방식
					$coatingRoll.find('select[data-field="coatWay"]').find('option').remove();
					for(var i=0; i < data.coatList.length; i++) {
						$coatingRoll.find('select[data-field="coatWay"]').append("<option value='"+ data.coatList[i].code +"'>"+ data.coatList[i].codeNm +"</option>");
					}
					$coatingRoll.find('select[data-field="coatWay"]').attr("title", data.coatList.length+" 건");
					// Coater no
					$coatingRoll.find('select[data-field="coatNo"]').find('option').remove();
					for(var i=0; i < data.coatNoList.length; i++) {
						$coatingRoll.find('select[data-field="coatNo"]').append("<option value='"+ data.coatNoList[i].code +"'>"+ data.coatNoList[i].codeNm +"</option>");
					}
					$coatingRoll.find('select[data-field="coatNo"]').attr("title", data.coatNoList.length+" 건");					
