...
<%@ page info="[2017.08.29] industry PCM 공통 팝업 HTML 엘리먼트" %>
...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<div class="wp-dim-layer">
   		...
   		<div id="js-indus-proc-info-insp-mod-pcm-popup" class="wp-pop-layer wp-pop-w940 wp-box-sizing wp-car-popup">
	    	<div class="wp-pop-title">
	    		<h1><spring:message code="TODO.KEY" text="거래선 공정정보 등록-PCM"/></h1>
	    		<button type="button" id="js-indus-proc-info-insp-mod-pcm-close" class="wp-btn-close-layer wp-spr-btn"><span>닫기</span></button>
	    	</div>
	        <div class="wp-pop-conts">
				...
				<div class="wp-pop-cont-scrollable">
					...
					<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-mod-pcm-basic-info">
					...
					<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-mod-pcm-line-info">
						<table>
					...
					<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-mod-pcm-material-info">
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="3" class="wp-al"><input type="text" data-field="matSetSite" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
									<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="matTon"><spring:message code="TODO.KEY" text="작업 물량(ton)"/></span></div></th>
									<td class="wp-al"><input type="text" data-field="matTon" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-mod-pcm-environment-info">
						<table>
							...
							<tbody>
								<tr>
									<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="coatRoomTemp"><spring:message code="TODO.KEY" text="Coater실"/><br><spring:message code="TODO.KEY" text="온도(℃)"/></span></div></th>
									<td class="wp-al"><input type="text" data-field="coatRoomTemp" name="" title="<spring:message code='TODO.KEY' text=''/>"></td>
									<th class="wp-ar"><div class="wp-temphum wp-icon-area"><span class="wp-icon" data-field="coatRoomHum"><spring:message code="TODO.KEY" text="Coater실"/><br><spring:message code="TODO.KEY" text="습도(%)"/></span></div></th>
					...
					<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-mod-pcm-rate-info">
						<table>
					...
					<div class="wp-clearfix">
						...
						<button type="button" id="js-indus-proc-info-insp-dt-mod-pcm-button" data-link="js-indus-proc-info-insp-dt-mod-pcm-popup" data-depth="2" class="wp-btn small white bgray plus wp-mb5 wp-fr"><spring:message code="TODO.KEY" text="추가"/></button>
					</div>
					<div class="wp-wrap-dl-paint-check02" id="js-indus-proc-info-insp-dt-mod-pcm">
					</div>
					<!-- //공정별 공정 정보 -->
					<!-- // scroll Area -->
				</div>
				...
				<div class="wp-btn-area">
					<button type="button" id="js-indus-proc-info-mod-pcm-popup-save-button" class="wp-btn big blue1 cr3 wp-pl18 wp-pr18">저장</button>
					<input type="hidden"  id="js-indus-proc-info-mod-pcm-pop-docNo"     value="">
					<input type="hidden"  id="js-indus-proc-info-mod-pcm-pop-orgDocNo"  value="">
					<input type="hidden"  id="js-indus-proc-info-mod-pcm-pop-item-type" value="">
				</div>
...
<!-- 공정별 공정 정보 - 스크립트-->
<script id="js-indus-proc-info-insp-dt-mod-pcm-template" type="text/x-handlebars-template">
{{#rows}}
        ...
        <a class="wp-list-paint-check02 wp-pointer">
            <div class="wp-clearfix">
                ...
                <div class="wp-rp-bttn">
                    <button type="button" class="wp-btn small white bgray mody" data-field="itemMod" data-link="js-indus-proc-info-insp-dt-mod-pcm-popup" data-depth="2" dataIndex="{{dataIndex}}" procId="{{procId}}"><span><spring:message code="TODO.KEY" text="수정"/></span></button>
    ...
    <dd class="wp-list-paint-check02-view" style="display: none;">
        ...
        <div class="wp-list-paint-check02 on">
            <div class="wp-clearfix">
                <strong class="wp-tit bold"><spring:message code="TODO.KEY" text="적용 공정 : "/>{{procNm}}</strong>
                <div class="wp-rp-bttn">
                    <button type="button" class="wp-btn small white bgray mody" data-field="itemModSub" data-link="js-indus-proc-info-insp-dt-mod-pcm-popup" data-depth="2" dataIndex="{{dataIndex}}" procId="{{procId}}"><span><spring:message code="TODO.KEY" text="수정"/></span></button>
            ...
            <div class="wp-wrap-table-st10">
                <table class="wp-table-st11">
                    ...
                    <tbody>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00009}}"><spring:message code="TODO.KEY" text="도료 구분"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00009}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00010}}"><spring:message code="TODO.KEY" text="도료 수지 타입"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00010}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00011}}"><spring:message code="TODO.KEY" text="피도물 외관(오염 여부 등)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00011}}</td>
                    </tr>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00012}}"><spring:message code="TODO.KEY" text="제품 생산량(kg)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00012}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00013}}"><spring:message code="TODO.KEY" text="제품 저장 기간(개월)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00013}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00014}}"><spring:message code="TODO.KEY" text="피도물 온도(℃)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00014}}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <!-- 공정 Coating Roll 정보 -->
            <div class="wp-clearfix">
                <strong class="wp-tit bold"><spring:message code="TODO.KEY" text="공정 Coating Roll 정보"/></strong>
            </div>
            <div class="wp-wrap-table-st10">
                <table class="wp-table-st11">
                    ...
                    <tbody>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00015}}"><spring:message code="TODO.KEY" text="코팅 방식"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00015}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00016}}"><spring:message code="TODO.KEY" text="주속비(L/S)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00016}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00017}}"><spring:message code="TODO.KEY" text="주속비(APR)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00017}}</td>
                    </tr>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00018}}"><spring:message code="TODO.KEY" text="주속비(PUR)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00018}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00019}}"><spring:message code="TODO.KEY" text="주속비(MR)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00019}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00020}}"><spring:message code="TODO.KEY" text="NIP 압력"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00020}}</td>
                    </tr>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00021}}"><spring:message code="TODO.KEY" text="경화 PMT(℃)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00021}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00022}}"><spring:message code="TODO.KEY" text="Backing 횟수"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00022}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00023}}"><spring:message code="TODO.KEY" text="T/Leveller Roll 투입"/><br><spring:message code="TODO.KEY" text="전 소지 온도(℃)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00023}}</td>
                    </tr>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00024}}"><spring:message code="TODO.KEY" text="T/Leveller Roll"/><br><spring:message code="TODO.KEY" text="청소 주기"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00024}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00025}}"><spring:message code="TODO.KEY" text="Coater No."/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00025}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00026}}"><spring:message code="TODO.KEY" text="육안 외관 상태"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00026}}</td>
                    </tr>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00027}}"><spring:message code="TODO.KEY" text="Target Coating Thickness(㎛)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00027}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00028}}"><spring:message code="TODO.KEY" text="경화 시간(sec)"/></span></div></th>
                        <td class="wp-al" colspan="3">{{detail.PCM_00028}}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="wp-wrap-table-st10">
                <table class="wp-table-st11">
                    ...
                    <tbody>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00029}}"><spring:message code="TODO.KEY" text="희석 후 점도(sec)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00029}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00030}}"><spring:message code="TODO.KEY" text="희석제 종류"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00030}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00031}}"><spring:message code="TODO.KEY" text="희석 비율(%)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00031}}</td>
                    </tr>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00032}}"><spring:message code="TODO.KEY" text="점도 측정시 온도(℃)"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00032}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00033}}"><spring:message code="TODO.KEY" text="캐치팬 내 도료 유동 상태"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00033}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.PCM_00034}}"><spring:message code="TODO.KEY" text="필터 상태"/></span></div></th>
                        <td class="wp-al">{{detail.PCM_00034}}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
...
var indusProcInfoInspModPCM = (function() {
	// item code
	...
	var initData = {
		init: function(){
			...
			// 공정별 공정 정보
			$('#js-indus-proc-info-insp-dt-mod-pcm').empty();
			
			// 기본정보 attr
			$basicInfo = $('#js-indus-proc-info-insp-mod-pcm-basic-info');
			// 라인정보 attr
			$line = $('#js-indus-proc-info-insp-mod-pcm-line-info');
			//소지 정보 attr
			$material = $('#js-indus-proc-info-insp-mod-pcm-material-info');
			// 환경 조건 및 특이사항 attr
			$environment = $('#js-indus-proc-info-insp-mod-pcm-environment-info');
			//도장 생산성 정보 attr
			$rate = $('#js-indus-proc-info-insp-mod-pcm-rate-info');
			//공정별 공정 정보 attr
			$item = $('#js-indus-proc-info-insp-dt-mod-pcm');
		},
		procItemCodeMapper: function(){ // item code 에 대하여 object id 를 mapping
			// 소지정보
			intProcItemCodeMpperMaterial["select[data-field='applMaterial']"] = "PCM_00001";// 적용소지
			intProcItemCodeMpperMaterial["input[data-field='matThickness']"] = "PCM_00002";// 소지 두께(mm)
			intProcItemCodeMpperMaterial["input[data-field='matWidth']"] = "PCM_00003";// 소지 폭(mm)
			intProcItemCodeMpperMaterial["input[data-field='matDemand']"] = "PCM_00004";// 수요가 
			intProcItemCodeMpperMaterial["input[data-field='matBuyer']"] = "PCM_00005";// 발주처	
			intProcItemCodeMpperMaterial["select[data-field='matUse']"] = "PCM_00006";// 소지용도
			intProcItemCodeMpperMaterial["input[data-field='matSetSite']"] = "PCM_00007";// 소재 설치 현장명
			intProcItemCodeMpperMaterial["input[data-field='matTon']"] = "PCM_00008";// 작업 물량(ton)
			// 환경 조건 및 특이사항
			intProcItemCodeMpperEnvironment["input[data-field='coatRoomTemp']"] = "PCM_00035";// Coater실 온도(℃)
			intProcItemCodeMpperEnvironment["input[data-field='coatRoomHum']"] = "PCM_00036";// Coater실 습도(%)
			intProcItemCodeMpperEnvironment["input[data-field='workerState']"] = "PCM_00037";// 작업자환경 (피복착용,오염)
			intProcItemCodeMpperEnvironment["input[data-field='cleanState']"] = "PCM_00038";// 도장공정 청결 상태(집진설비)
			intProcItemCodeMpperEnvironment["input[data-field='moveStateTemp']"] = "PCM_00039";// 도료 이송 조건 (5~25℃, 85%↓)
			intProcItemCodeMpperEnvironment["input[data-field='moveStateHumidity']"] = "PCM_00040";// 도료 이송 조건 (5~25℃, 85%↓)
			intProcItemCodeMpperEnvironment["input[data-field='stockStateTemp']"] = "PCM_00041";// 도료 보관 조건 (5~25℃,85%↓)
			intProcItemCodeMpperEnvironment["input[data-field='stockStateHumidity']"] = "PCM_00042";// 도료 보관 조건 (5~25℃,85%↓)
			// 도장 생산성 정보
			intProcItemCodeMpperRate["input[data-field='yield']"] = "PCM_00043";// 가동률(%)
			intProcItemCodeMpperRate["input[data-field='defectRate']"] = "PCM_00044";// 불량률(%)
			intProcItemCodeMpperRate["input[data-field='returnRate']"] = "PCM_00045";// 반품률(%)
		},
		setInfo: function(docNo, itemType){
			...
			$("#js-indus-proc-info-mod-pcm-pop-item-type").val(itemType);
			
			// 공정별 공정 정보
			var source = $('#js-indus-proc-info-insp-dt-mod-pcm-template').html();
	...
	var pageQueryEvent = {
		init: function(){
			...
			$("#js-indus-proc-info-insp-dt-mod-pcm-button").off().on('click', function(e){
				fn_openPop($(this));
				indusProcInfoInspDtModPCM.init(
			...
			$basicInfo.find('button[data-field="empSearchButton"]').off().on('click', function(){
				initIndustryEmpRetrievePopup('js-indus-proc-info-mod-pcm-popup');
			});
			
			// 저장
			$("#js-indus-proc-info-mod-pcm-popup-save-button").off().on('click', this.saveData);
		},
		saveData: function(){ // 저장
			...
			var dtProcInfoDt = []; // 제품 정보, 공정 Coating Roll 정보, 희석 조건
			...
			var params = {
				...
				, procInfoDt			: JSON.stringify(dtProcInfoDt) // 제품 정보, 공정 Coating Roll 정보, 희석 조건
	...
	var ifFn = {
		...
		pageSetData: function() {
			...
			$('#js-indus-proc-info-insp-dt-mod-pcm').empty().append(result);
			...
			$item.find('button[data-field="itemMod"]').off().on("click", function() {
				...
				for(var j=0; j<procList.length; j++){
						if(procList[j].dtProcId.id == procId){
							indusProcInfoInspDtModPCM.ifFn.setModData(procList[j].dtProcId, procList[j].dtProcInfoDt, procList[j].dtShare, procList[j].dtItem);
						}
					}
		...
		pageInit: function() {
			var dtProcId = indusProcInfoInspDtModPCM.ifFn.getProcId();
			var dtProcInfoDt = indusProcInfoInspDtModPCM.ifFn.getProcInfoDt();
			var dtShare = indusProcInfoInspDtModPCM.ifFn.getShare();
			var dtItem = indusProcInfoInspDtModPCM.ifFn.getItem();
		...
		success: function(response, status, jqueryXHR) {
			...
			if (typeof response.message !== 'undefined') {
				...
				if (message === 'OK') {
					...
					$("#js-indus-proc-info-insp-mod-pcm-close").click();
	...
	var retrieveIndProcDetail = {
		...
		setData: function(data){
			...
			for(var k=0; k<dtProcIdList.length; k++){
				...
				var dtProcId = {};
				var dtProcInfoDt = [];
				// 제품 정보, 공정 Coating Roll 정보, 희석 조건
				for(var i=0; i<data.detail2.length; i++){
			...
			for(var j=0; j<procList.length; j++){
				...
				indusProcInfoInspDtModPCM.ifFn.setModData(procList[j].dtProcId, procList[j].dtProcInfoDt, procList[j].dtShare, procList[j].dtItem);	
				indusProcInfoInspDtModPCM.ifFn.setPage();
			}
