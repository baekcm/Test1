...
<%@ page info="[2017.09.05] industry 분체 공통 팝업 HTML 엘리먼트" %>
...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<div class="wp-dim-layer">
   		...
   		<div id="js-indus-proc-info-insp-mod-powder-popup" class="wp-pop-layer wp-pop-w940 wp-box-sizing wp-car-popup">
	    	<div class="wp-pop-title">
	    		<h1><spring:message code="TODO.KEY" text="거래선 공정정보 등록-분체"/></h1>
	    		<button type="button" id="js-indus-proc-info-insp-mod-powder-close" class="wp-btn-close-layer wp-spr-btn"><span>닫기</span></button>
	    	</div>
	        <div class="wp-pop-conts">
				...
				<div class="wp-pop-cont-scrollable">
					...
					<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-mod-powder-basic-info">
					...
					<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-mod-powder-line-info">
						<table>
					...
					<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-mod-powder-material-info">
						<table>
					...
					<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-mod-powder-environment-info">
						<table>
					...
					<div class="wp-table-st1 wp-issue-apply" id="js-indus-proc-info-insp-mod-powder-rate-info">
						<table>
					...
					<div class="wp-clearfix">
						...
						<button type="button" id="js-indus-proc-info-insp-dt-mod-powder-button" data-link="js-indus-proc-info-insp-dt-mod-powder-popup" data-depth="2" class="wp-btn small white bgray plus wp-mb5 wp-fr"><spring:message code="TODO.KEY" text="추가"/></button>
					</div>
					<div class="wp-wrap-dl-paint-check02" id="js-indus-proc-info-insp-dt-mod-powder">
					</div>
					<!-- //공정별 공정 정보 -->
					<!-- // scroll Area -->
				</div>
				...
				<div class="wp-btn-area">
					<button type="button" id="js-indus-proc-info-mod-powder-popup-save-button" class="wp-btn big blue1 cr3 wp-pl18 wp-pr18">저장</button>
					<input type="hidden"  id="js-indus-proc-info-mod-powder-pop-docNo"     value="">
					<input type="hidden"  id="js-indus-proc-info-mod-powder-pop-orgDocNo"  value="">
					<input type="hidden"  id="js-indus-proc-info-mod-powder-pop-item-type" value="">
				</div>
...
<!-- 공정별 공정 정보 - 스크립트-->
<script id="js-indus-proc-info-insp-dt-mod-powder-template" type="text/x-handlebars-template">
{{#rows}}
        ...
        <a class="wp-list-paint-check02 wp-pointer">
            <div class="wp-clearfix">
                ...
                <div class="wp-rp-bttn">
                    <button type="button" class="wp-btn small white bgray mody" data-field="itemMod" data-link="js-indus-proc-info-insp-dt-mod-powder-popup" data-depth="2" dataIndex="{{dataIndex}}" procId="{{procId}}"><span><spring:message code="TODO.KEY" text="수정"/></span></button>
    ...
    <dd class="wp-list-paint-check02-view" style="display: none;">
        ...
        <div class="wp-list-paint-check02 on">
            <div class="wp-clearfix">
                <strong class="wp-tit bold"><spring:message code="TODO.KEY" text="적용 공정 : "/>{{procNm}}</strong>
                <div class="wp-rp-bttn">
                    <button type="button" class="wp-btn small white bgray mody" data-field="itemModSub" data-link="js-indus-proc-info-insp-dt-mod-powder-popup" data-depth="2" dataIndex="{{dataIndex}}" procId="{{procId}}"><span><spring:message code="TODO.KEY" text="수정"/></span></button>
            ...
            <div class="wp-wrap-table-st10">
                <table class="wp-table-st11">
                    ...
                    <tbody>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00008}}"><spring:message code="TODO.KEY" text="도료 구분"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00008}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00009}}"><spring:message code="TODO.KEY" text="도료 수지 타입"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00009}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00010}}"><spring:message code="TODO.KEY" text="피도물 외관(오염 여부 등)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00010}}</td>
                    </tr>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00011}}"><spring:message code="TODO.KEY" text="제품 생산량(kg)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00011}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00012}}"><spring:message code="TODO.KEY" text="제품 저장 기간(개월)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00012}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00013}}"><spring:message code="TODO.KEY" text="피도물 온도(℃)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00013}}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="wp-wrap-table-st10">
                <table class="wp-table-st11">
                    ...
                    <tbody>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00014}}"><spring:message code="TODO.KEY" text="도장압력(Bar)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00014}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00015}}"><spring:message code="TODO.KEY" text="토출량(Bar)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00015}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00016}}"><spring:message code="TODO.KEY" text="예열기 통과 시간(min)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00016}}</td>
                    </tr>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00017}}"><spring:message code="TODO.KEY" text="도장 전압(KV)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00017}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00018}}"><spring:message code="TODO.KEY" text="예열기 설정 온도(℃)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00018}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00019}}"><spring:message code="TODO.KEY" text="분위기 온도(센서값, ℃)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00019}}</td>
                    </tr>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00020}}"><spring:message code="TODO.KEY" text="도장 전 소지 온도(℃)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00020}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00021}}"><spring:message code="TODO.KEY" text="건조로 통과 시간(min)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00021}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00022}}"><spring:message code="TODO.KEY" text="건조로 설정 온도 (센서값, ℃)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00022}}</td>
                    </tr>
                    <tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00023}}"><spring:message code="TODO.KEY" text="Target Coating Thickness(㎛)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00023}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00024}}"><spring:message code="TODO.KEY" text="Pitch Time(sec)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00024}}</td>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00025}}"><spring:message code="TODO.KEY" text="패턴폭(cm)"/></span></div></th>
                        <td class="wp-al">{{detail.POWDER_00025}}</td>
                    </tr>
					<tr>
                        <th scope="row"><div class="wp-temphum wp-icon-area"><span class="{{css.POWDER_00026}}"><spring:message code="TODO.KEY" text="도장 부스 No."/></span></div></th>
                        <td class="wp-al" colspan="5">{{detail.POWDER_00026}}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
...
var indusProcInfoInspModPowder = (function() {
	// item code
	...
	var initData = {
		init: function(){
			...
			// 공정별 공정 정보
			$('#js-indus-proc-info-insp-dt-mod-powder').empty();
			
			// 기본정보 attr
			$basicInfo = $('#js-indus-proc-info-insp-mod-powder-basic-info');
			// 라인정보 attr
			$line = $('#js-indus-proc-info-insp-mod-powder-line-info');
			//소지 정보 attr
			$material = $('#js-indus-proc-info-insp-mod-powder-material-info');
			// 환경 조건 및 특이사항 attr
			$environment = $('#js-indus-proc-info-insp-mod-powder-environment-info');
			//도장 생산성 정보 attr
			$rate = $('#js-indus-proc-info-insp-mod-powder-rate-info');
			//공정별 공정 정보 attr
			$item = $('#js-indus-proc-info-insp-dt-mod-powder');
		},
		procItemCodeMapper: function(){ // item code 에 대하여 object id 를 mapping
			// 소지정보
			intProcItemCodeMpperMaterial["select[data-field='applMaterial']"] = "POWDER_00001";// 적용소지
			intProcItemCodeMpperMaterial["input[data-field='matThickness']"] = "POWDER_00002";// 소지 두께(mm)
			intProcItemCodeMpperMaterial["input[data-field='matWidth']"] = "POWDER_00003";// 소지 폭(mm)
			intProcItemCodeMpperMaterial["input[data-field='matDemand']"] = "POWDER_00004";// 수요가 
			intProcItemCodeMpperMaterial["input[data-field='matBuyer']"] = "POWDER_00005";// 발주처	
			intProcItemCodeMpperMaterial["select[data-field='matUse']"] = "POWDER_00006";// 소지용도
			intProcItemCodeMpperMaterial["input[data-field='matSetSite']"] = "POWDER_00007";// 소재 설치 현장명
			
			// 환경 조건 및 특이사항
			intProcItemCodeMpperEnvironment["input[data-field='coatRoomTemp']"] = "POWDER_00027";// 도장실 온도(℃)
			intProcItemCodeMpperEnvironment["input[data-field='coatRoomHum']"] = "POWDER_00028";// 도장실 습도(%)
			intProcItemCodeMpperEnvironment["input[data-field='workerState']"] = "POWDER_00029";// 작업자환경 (피복착용,오염)
			intProcItemCodeMpperEnvironment["input[data-field='cleanState']"] = "POWDER_00030";// 도장공정 청결 상태(집진설비)
			intProcItemCodeMpperEnvironment["input[data-field='moveStateTemp']"] = "POWDER_00031";// 도료 이송 조건 (5~25℃, 85%↓)
			intProcItemCodeMpperEnvironment["input[data-field='moveStateHumidity']"] = "POWDER_00032";// 도료 이송 조건 (5~25℃, 85%↓)
			intProcItemCodeMpperEnvironment["input[data-field='stockStateTemp']"] = "POWDER_00033";// 도료 보관 조건 (5~25℃,85%↓)
			intProcItemCodeMpperEnvironment["input[data-field='stockStateHumidity']"] = "POWDER_00034";// 도료 보관 조건 (5~25℃,85%↓)
			
			// 도장 생산성 정보
			intProcItemCodeMpperRate["input[data-field='yield']"] = "POWDER_00035";// 가동률(%)
			intProcItemCodeMpperRate["input[data-field='defectRate']"] = "POWDER_00036";// 불량률(%)
			intProcItemCodeMpperRate["input[data-field='returnRate']"] = "POWDER_00037";// 반품률(%)
		},
		setInfo: function(docNo, itemType){
			...
			$("#js-indus-proc-info-mod-powder-pop-item-type").val(itemType);
			
			// 공정별 공정 정보
			var source = $('#js-indus-proc-info-insp-dt-mod-powder-template').html();
	...
	var pageQueryEvent = {
		init: function(){
			...
			$("#js-indus-proc-info-insp-dt-mod-powder-button").off().on('click', function(e){
				fn_openPop($(this));
				indusProcInfoInspDtModPowder.init(
			...
			$basicInfo.find('button[data-field="empSearchButton"]').off().on('click', function(){
				initIndustryEmpRetrievePopup('js-indus-proc-info-mod-powder-popup');
			});
			
			// 저장
			$("#js-indus-proc-info-mod-powder-popup-save-button").off().on('click', this.saveData);
		},
	...
	var ifFn = {
		...
		pageSetData: function() {
			...
			$('#js-indus-proc-info-insp-dt-mod-powder').empty().append(result);
			...
			$item.find('button[data-field="itemMod"]').off().on("click", function() {
				...
				for(var j=0; j<procList.length; j++){
						if(procList[j].dtProcId.id == procId){
							indusProcInfoInspDtModPowder.ifFn.setModData(procList[j].dtProcId, procList[j].dtProcInfoDt, procList[j].dtShare, procList[j].dtItem);
						}
					}
		...
		pageInit: function() {
			var dtProcId = indusProcInfoInspDtModPowder.ifFn.getProcId();
			var dtProcInfoDt = indusProcInfoInspDtModPowder.ifFn.getProcInfoDt();
			var dtShare = indusProcInfoInspDtModPowder.ifFn.getShare();
			var dtItem = indusProcInfoInspDtModPowder.ifFn.getItem();
		...
		success: function(response, status, jqueryXHR) {
			...
			if (typeof response.message !== 'undefined') {
				...
				if (message === 'OK') {
					...
					$("#js-indus-proc-info-insp-mod-powder-close").click();
	...
	var retrieveIndProcDetail = {
		...
		setData: function(data){
			...
			for(var j=0; j<procList.length; j++){
				...
				indusProcInfoInspDtModPowder.ifFn.setModData(procList[j].dtProcId, procList[j].dtProcInfoDt, procList[j].dtShare, procList[j].dtItem);	
				indusProcInfoInspDtModPowder.ifFn.setPage();
			}
